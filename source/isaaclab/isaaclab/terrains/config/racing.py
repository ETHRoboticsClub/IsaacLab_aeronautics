...
RACING_GATES_RANDOM_CFG = lambda seed: TerrainGeneratorCfg(
    ...
    sub_terrains={
        "racing_gates": terrain_gen.MeshRacingGatesTerrainCfg(
            proportion=1.0,
            seed=seed,  # Ensure the random trajectory is reproducible
            ...
            gate_size_range=(0.7, 0.7001),  # Slightly smaller gates for more challenge
...
def create_racing_gates_terrain(
    ...
    return RACING_GATES_RANDOM_CFG(seed)